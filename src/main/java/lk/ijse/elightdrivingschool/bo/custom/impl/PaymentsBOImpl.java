...
import lk.ijse.elightdrivingschool.bo.custom.PaymentsBO;
...
import lk.ijse.elightdrivingschool.dao.custom.PaymentsDAO;
import lk.ijse.elightdrivingschool.dto.PaymentsDTO;
import lk.ijse.elightdrivingschool.entity.Payments;
...
public class PaymentsBOImpl implements PaymentsBO {
    ...
    private final PaymentsDAO  paymentDAO = (PaymentsDAO ) DAOFactory.getInstance().getDAO(DAOTypes.PAYMENTS);
